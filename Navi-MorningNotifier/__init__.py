...
def main(mytimer: func.TimerRequest) -> None:
    ...
    def stock():
        ...
        if yesterday.strftime('%m-%d-%y') in offday and yesterday.weekday() == 0:
            ...
            stock_prev = {i: float(round(yf.download(i,holimonday,holimonday)['Adj Close'].iloc[0], 2)) for i in ticker}
            ...
            stock_live = {i: float(round(yf.download(i,today,today)['Adj Close'].iloc[0],2))for i in ticker}
            stock_prev = {i: float(round(yf.download(i,holiday,holiday)['Adj Close'].iloc[0], 2)) for i in ticker}
            ...
            stock_live = {i: float(round(yf.download(i,today,today)['Adj Close'].iloc[0],2))for i in ticker}
            stock_prev = {i: float(round(yf.download(i,friday,friday)['Adj Close'].iloc[0], 2)) for i in ticker}
            ...
            stock_live = {i: float(round(yf.download(i,today,today)['Adj Close'].iloc[0],2))for i in ticker}
            stock_prev = {i: float(round(yf.download(i,yesterday,yesterday)['Adj Close'].iloc[0], 2)) for i in ticker}
